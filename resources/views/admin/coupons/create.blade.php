...
@section('page-title', 'Yeni Kupon Ekle')
    ...
    <form action="{{ route('admin.coupons.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <p class="text-xs text-gray-500 mt-1">Boş bırakılırsa tüm kategorilere uygulanır</p>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <p class="text-xs text-gray-500 mt-1">Boş bırakılırsa tüm ürünlere uygulanır</p>
            </div>
        </div>
